    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-center text-[#7AB51D] mb-12">Objectives</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {objectives.map((obj, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-lg border-2 border-gray-100 hover:border-[#7AB51D] transition-colors">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-16 h-16 bg-[#7AB51D] rounded-full flex items-center justify-center text-white">
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-xl group">
                <div className="relative h-64 bg-gray-300">
                  ...
                  <div className="absolute bottom-0 right-0 w-16 h-16 bg-[#7AB51D] opacity-75" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 100%)' }}></div>
                </div>
                <div className="p-4 text-center">
                  ...
                  <div className="flex justify-center gap-2">
                    <a href="#" className="w-6 h-6 bg-gray-700 rounded flex items-center justify-center text-white hover:bg-[#7AB51D] transition-colors">
