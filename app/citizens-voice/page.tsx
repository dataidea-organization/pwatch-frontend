...
import { MessageSquare, Send, AlertCircle, User, FileText, Scale, Share2, ExternalLink, TrendingUp, CheckCircle, Users, BarChart3 } from 'lucide-react';
import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';
import { submitFeedback, FeedbackSubmission, fetchCitizensVoiceFeedbackLinks, CitizensVoiceFeedbackLinks } from '@/lib/api';
  ...
  return (
    <div className="min-h-screen bg-[#f5f0e8]">
      <main className="relative">
        ...
        <div id="ways-to-engage" className="mb-10 scroll-mt-6">
        ...
        <div id="feedback" className="mt-8 bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden scroll-mt-6">
        ...
        {/* Info Section */}
        <div id="about" className="mt-8 relative bg-gradient-to-br from-[#fafaf8] to-[#f5f0e8] rounded-xl shadow-md border border-gray-200 p-6 overflow-hidden scroll-mt-6">
          <div className="absolute top-0 right-0 w-24 h-24 opacity-5">
            <div className="absolute inset-0 bg-[#2d5016] rounded-full blur-2xl"></div>
          </div>
